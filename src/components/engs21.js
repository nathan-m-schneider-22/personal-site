        ...
        <div className="engs">
          ...
          <div className="engs-section">
            ...
            <div>
              ...
              <figcaption>Jason prototype: non-functional, configurable</figcaption>

            </div>
            <div>
              <img src={mine} className="engs-pic" alt="my prototype" />
              <figcaption>My prototype: functional, non-configurable</figcaption>
            </div>
          ...
          <div className="engs-section">
            ...
            <div>
              ...
              <figcaption>Joystick to letter layout</figcaption>
            </div>

            <div>
              <img src={functional} className="engs-pic" alt="functional prototype" />
              <figcaption>Functional testing prototype</figcaption>
            </div>
          </div>
          ...
          <div className="engs-section">
            ...
            <div>
              ...
              <figcaption>Lego-based configurability prototype</figcaption>
            </div>
          </div>
